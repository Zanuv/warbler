...
def logout():
    ...
    # IMPLEMENT THIS
    # Call do_logout to log the user out
    do_logout()
...
def profile():
    ...
    if form.validate_on_submit():
        if User.authenticate(curr_user.username, form.password.data):
            ...
            curr_user.image_url = form.image_url.data or "/static/images/default-pic.png"
            curr_user.header_image_url = form.header_image_url.data or "/static/images/warbler-hero.jpg"
    ...
    return render_template('users/edit.html', form=form, user_id=curr_user.id)
